      ...
      var data = {
        ...
        start: $.format.date(new Date(calEvent.start._i),'MMM d, yyyy h:mm a'),
			...
			var buttons = $('<button id="event_cancel" type="cancel" class="btn btn-default btn-label-left">'+
							...
							'Save changes'+
							'</button>'+
							'<button id="event_change_status" class="btn btn-primary btn-label-left pull-right">'+
							'<span><i class="fa fa-clock-o"></i></span>'+
							'Change status'+
							'</button>');
...
//  Custom js
  $('body').on('click', '#event_change_status', function(){
...
//  $.get('update_event.php?id=2',function(data){
//    console.log(data)
//  })
});
